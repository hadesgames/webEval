...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.developer'
        db.add_column('web_eval__core_userprofile', 'developer', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.developer'
        db.delete_column('web_eval__core_userprofile', 'developer')
