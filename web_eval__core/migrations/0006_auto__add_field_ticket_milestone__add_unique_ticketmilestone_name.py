...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('web_eval__core_ticket', 'milestone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['web_eval__core.TicketMilestone'], null=True, blank=True), keep_default=False)

        # Adding unique constraint on 'TicketMilestone', fields ['name']
        db.create_unique('web_eval__core_ticketmilestone', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TicketMilestone', fields ['name']
        db.delete_unique('web_eval__core_ticketmilestone', ['name'])

        # Deleting field 'Ticket.milestone'
        db.delete_column('web_eval__core_ticket', 'milestone_id')
