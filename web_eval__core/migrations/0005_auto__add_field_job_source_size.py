...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.source_size'
        db.add_column('web_eval__core_job', 'source_size', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.source_size'
        db.delete_column('web_eval__core_job', 'source_size')
