...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TicketMilestone.version'
        db.add_column('web_eval__core_ticketmilestone', 'version', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TicketMilestone.version'
        db.delete_column('web_eval__core_ticketmilestone', 'version')
