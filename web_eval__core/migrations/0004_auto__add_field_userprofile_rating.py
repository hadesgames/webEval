...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('web_eval__core_userprofile', 'rating', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.rating'
        db.delete_column('web_eval__core_userprofile', 'rating')
