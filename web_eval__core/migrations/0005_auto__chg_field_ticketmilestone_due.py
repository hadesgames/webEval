...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TicketMilestone.due'
        db.alter_column('web_eval__core_ticketmilestone', 'due', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'TicketMilestone.due'
        db.alter_column('web_eval__core_ticketmilestone', 'due', self.gf('django.db.models.fields.DateTimeField')())
