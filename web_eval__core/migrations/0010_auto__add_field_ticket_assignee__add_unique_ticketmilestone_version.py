...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.assignee'
        db.add_column('web_eval__core_ticket', 'assignee', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='assignee', null=True, to=orm['web_eval__core.UserProfile']), keep_default=False)

        # Adding unique constraint on 'TicketMilestone', fields ['version']
        db.create_unique('web_eval__core_ticketmilestone', ['version'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'TicketMilestone', fields ['version']
        db.delete_unique('web_eval__core_ticketmilestone', ['version'])

        # Deleting field 'Ticket.assignee'
        db.delete_column('web_eval__core_ticket', 'assignee_id')
