...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.source_size'
        db.alter_column('web_eval__core_job', 'source_size', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'Job.source_size'
        db.alter_column('web_eval__core_job', 'source_size', self.gf('django.db.models.fields.FloatField')())
