...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Job.proccessing'
        db.delete_column('web_eval__core_job', 'proccessing')

        # Adding field 'Job.processing'
        db.add_column('web_eval__core_job', 'processing', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Job.proccessing'
        db.add_column('web_eval__core_job', 'proccessing', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Job.processing'
        db.delete_column('web_eval__core_job', 'processing')
