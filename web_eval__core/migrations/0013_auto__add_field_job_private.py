...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Job.private'
        db.add_column('web_eval__core_job', 'private', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.private'
        db.delete_column('web_eval__core_job', 'private')
