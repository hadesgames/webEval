...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('web_eval__core_job', 'language', self.gf('django.db.models.fields.CharField')(default='cpp', max_length=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Job.language'
        db.delete_column('web_eval__core_job', 'language')
