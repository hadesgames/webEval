...
urlpatterns = patterns('',
    ...
    (r'^$', 'webEval.web_eval__core.blog__controller.index'),
   ...
   # (r'^openid/', include('django_openid_auth.urls')),
    ...
    (r'^json/get_rounds_for_problem', 'webEval.web_eval__core.json__controller.get_rounds_for_problem'),
    (r'^scripts/search_tags/$', 'webEval.web_eval__core.blog__controller.get_tags_ajax'),
